...
public class MyEventHandler {
	...
	public static void onTick(TickEvent ev){
		if (MineLoader.isPlayerOnline("guyde2011")){
			MineLoader.setTime((EntityPlayerMP) MineLoader.getPlayer("guyde2011"), 18000L);
		}
	}
	
	@EventHandler
	public static void onGuiClick(ItemCursorClickEvent ev){
		if (ev.stack!=null){
			ev.player.addChatMessage(new ChatComponentText("clicked " + ev.stack.getDisplayName()));
			ev.Cancel();
		}
	}
